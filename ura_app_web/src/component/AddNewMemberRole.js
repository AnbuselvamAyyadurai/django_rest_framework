...
class AddNewMemberRole extends Component {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.container1}>
                    <Text style={styles.title}>{"What's his/her role in the \nfamily ?"}</Text>
                </View>
...
export default connect(StateToProps, DispatchToProps)(AddNewMemberRole);